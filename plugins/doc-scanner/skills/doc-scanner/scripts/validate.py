...
def check_page_count(sitemap, md_files, skill_dir, result):
    ...
    # Warning pages get consolidated into WARNINGS.md, so the file count will be
    # lower than the sitemap page count by (warning_pages - 1). We use a simpler
    # heuristic: just subtract all warning-titled pages.
